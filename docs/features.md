...
| Registering a project from the window | Implemented | `Add project…` opens the file panel and registers the chosen Compose file through `stack.LoadIn` and `Machine.Register` | Local build; not installed |
